...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--which_model_netD_vid', type=str, default='basic', help='selects model to use for netD_vid')
        self.parser.add_argument('--which_model_netD_seq', type=str, default='SeqCNNDiscriminator', help='selects model to use for netD_seq')
        self.parser.add_argument('--which_model_netE', type=str, default='ResnetVideoEncoder', help='selects model to use for netE (vid encoder)')
        self.parser.add_argument('--which_model_netG_vid', type=str, default='ResnetVideoGenerator', help='selects model to use for netG_vid')
        self.parser.add_argument('--which_model_netG_seq', type=str, default='SeqCNNGenerator', help='selects model to use for netG_seq')
