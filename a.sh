...
python train.py --dataset_mode v --model vid2seq_model --which_model_netG_seq SeqRNNGenerator --which_direction AtoB --norm batch --niter 10 --niter_decay 10 --batchSize 1 --name test-cnn+rnn-actionA --depth 30 --max_dataset_size 5000 --output_nc 3 --input_nc 3 --sensor_types angle,speedX,action --data_dir /data/dataset/torcs_data/aalborg/ --input_num 2 --gpu_ids 1 --train_mode seq_only --print_freq 2 --pretrain --seq_type action --use_encoder
python train.py --dataset_mode v --model vid2seq_model --which_model_netG_seq SeqRNNGenerator --which_direction AtoB --norm batch --niter 10 --niter_decay 10 --batchSize 1 --name test-cnn+rnn-actionA-1 --depth 30 --max_dataset_size 5000 --output_nc 3 --input_nc 3 --sensor_types angle,speedX,action --data_dir /data/dataset/torcs_data/aalborg/ --input_num 2 --gpu_ids 1 --train_mode seq_only --print_freq 5 --pretrain --seq_type action --use_encoder
